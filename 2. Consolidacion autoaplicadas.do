...
**Recordar que en RM hay que borrar las variables personalizadas de 6 a la 9 para poder consolidar con las 
**otras regiones
  ...
  foreach o of numlist 1/5{
	...
	**correcciones finales**
	...
	if `aux'==1{
		...
		append using "$salida\Enadelpi_2021_autoaplicada.dta", force 
		save "$salida\Enadelpi_2021_autoaplicada.dta", replace
	}
...
destring e2_* e1_*, replace
tostring e1_nombre_* e1_tareas_* e2_nombre_* e2_tareas_*, replace

save "$salida\Enadelpi_2021_autoaplicada.dta", replace

**hay que recuperar el folio 
